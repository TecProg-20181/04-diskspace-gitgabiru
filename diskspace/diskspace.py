...
@contract(largest_size='int,>=0', total_size='int,>=0', depth='int,>=0',
          path='string', file_tree='dict(str: *)', file_tree_node='dict(str: *)',
          returns='None')
...
contract(depth='int,>=0', order='bool', directory='string', returns='int')
